...
export class DemoAccountService {
  ...
  static async createDemoAccount(account: DemoAccount): Promise<{
    ...
    try {
      ...
      console.log(
        `Demo account created: ${account.email} with role: ${account.role}`,
      );
   ...
   * Create role-specific profile in Firestore
   */
  private static async createRoleProfile(
    uid: string,
    account: DemoAccount,
  ): Promise<void> {
    const baseProfile = {
   ...
   */
  private static async createPoliceProfile(
    uid: string,
    baseProfile: any,
  ): Promise<void> {
   ...
   */
  private static async createAmbulanceProfile(
    uid: string,
    baseProfile: any,
  ): Promise<void> {
   ...
   */
  private static async createFireBrigadeProfile(
    uid: string,
    baseProfile: any,
  ): Promise<void> {
   ...
   */
  private static async createHospitalProfile(
    uid: string,
    baseProfile: any,
  ): Promise<void> {
  ...
  static async testDemoLogin(
    ...
    try {
      ...
      const userDoc = await import("firebase/firestore").then(
        ({ doc, getDoc }) => getDoc(doc(db, "users", user.uid)),
      );
