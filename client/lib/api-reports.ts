 ...
 */
export const submitReportAPI = async (
...
export const updateReportStatusAPI = async (
  ...
  try {
    const response = await fetch(
      `${API_BASE}/reports/${problemType}/${reportId}/status`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
...
export const submitReportHybrid = async (
  ...
  if (preferServerAPI) {
    try {
      ...
      console.warn(
        "Server API submission failed, falling back to client Firebase:",
        serverError,
      );
      ...
      try {
        ...
        throw new Error(
          "Failed to submit report via both server and client methods",
        );
      }
    }
  } else {
    try {
      ...
      console.warn(
        "Client Firebase submission failed, falling back to server API:",
        clientError,
      );
      ...
      try {
        ...
        throw new Error(
          "Failed to submit report via both client and server methods",
        );
      }
    }
  }
