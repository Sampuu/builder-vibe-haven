...
export const testUsersCollection = async () => {
  ...
  try {
    ...
    console.log(
      "✅ Real-time listeners available: subscribeToUsers, subscribeToUser",
    );
...
export const testHelpRequestsCollection = async () => {
  ...
  try {
    ...
    console.log(
      "✅ Real-time listeners available: subscribeToHelpRequests, subscribeToHelpRequest",
    );
...
export const testNewsUpdatesCollection = async () => {
  ...
  try {
    ...
    console.log(
      "✅ Real-time listeners available: subscribeToNews, subscribeToNewsItem",
    );
...
export const testIncidentsCollection = async () => {
  ...
  try {
    ...
    console.log(
      "✅ Real-time listeners available: subscribeToIncidents, subscribeToIncident",
    );
...
export const runAllFirebaseTests = async () => {
  ...
  if (passed === total) {
    console.log(
      "🎉 All Firebase integration tests passed! Your Firebase setup is ready for production.",
    );
  } else {
    console.log(
      "⚠️ Some tests failed. Please review the Firebase configuration.",
    );
  }
