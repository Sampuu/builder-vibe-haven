...
export class UserService {
  static async createUser(
    ...
    return DatabaseService.create<UserProfile>(
      COLLECTIONS.USERS,
      userData as any,
    );
  }
  ...
  static async updateUser(
    ...
    return DatabaseService.update<UserProfile>(
      COLLECTIONS.USERS,
      uid,
      userData,
    );
  ...
  static async getUsersByRole(role: UserRole): Promise<UserProfile[]> {
    return DatabaseService.query<UserProfile>(COLLECTIONS.USERS, [
...
export class PoliceService {
  static async createReport(
    reportData: Omit<PoliceReport, "reportId" | "timestamp">,
  ): Promise<string> {
    return DatabaseService.create<PoliceReport>(
  ...
  static async getReport(reportId: string): Promise<PoliceReport | null> {
    return DatabaseService.get<PoliceReport>(
      COLLECTIONS.POLICE_REPORTS,
      reportId,
    );
  }
  ...
  static async updateReport(
    ...
    return DatabaseService.update<PoliceReport>(
      COLLECTIONS.POLICE_REPORTS,
      reportId,
      reportData,
    );
...
export class AmbulanceService {
  static async createRequest(
    requestData: Omit<AmbulanceRequest, "requestId" | "timestamp">,
  ): Promise<string> {
    return DatabaseService.create<AmbulanceRequest>(
  ...
  static async getRequest(requestId: string): Promise<AmbulanceRequest | null> {
    return DatabaseService.get<AmbulanceRequest>(
      COLLECTIONS.AMBULANCE_REQUESTS,
      requestId,
    );
  }
  ...
  static async updateRequest(
    ...
    return DatabaseService.update<AmbulanceRequest>(
      COLLECTIONS.AMBULANCE_REQUESTS,
      requestId,
      requestData,
    );
      ...
      [
        {
          field: "status",
          operator: "in",
          value: ["requested", "dispatched", "en_route", "arrived"],
        },
      ],
      "timestamp",
    );
...
export class FireBrigadeService {
  static async createReport(
    reportData: Omit<FireBrigadeReport, "reportId" | "timestamp">,
  ): Promise<string> {
    return DatabaseService.create<FireBrigadeReport>(
  ...
  static async getReport(reportId: string): Promise<FireBrigadeReport | null> {
    return DatabaseService.get<FireBrigadeReport>(
      COLLECTIONS.FIRE_BRIGADE_REPORTS,
      reportId,
    );
  }
  ...
  static async updateReport(
    reportId: string,
    reportData: Partial<FireBrigadeReport>,
  ): Promise<void> {
    return DatabaseService.update<FireBrigadeReport>(
      COLLECTIONS.FIRE_BRIGADE_REPORTS,
      reportId,
      reportData,
    );
      ...
      [
        {
          field: "status",
          operator: "in",
          value: ["reported", "responding", "on_scene", "controlled"],
        },
      ],
      "timestamp",
    );
...
export class HospitalService {
  static async createRecord(
    recordData: Omit<HospitalRecord, "recordId" | "lastUpdated">,
  ): Promise<string> {
    return DatabaseService.create<HospitalRecord>(
  ...
  static async getRecord(recordId: string): Promise<HospitalRecord | null> {
    return DatabaseService.get<HospitalRecord>(
      COLLECTIONS.HOSPITAL_RECORDS,
      recordId,
    );
  }
  ...
  static async updateRecord(
    ...
    return DatabaseService.update<HospitalRecord>(
      COLLECTIONS.HOSPITAL_RECORDS,
      recordId,
      recordData,
    );
      ...
      [
        {
          field: "status",
          operator: "in",
          value: ["operational", "emergency_only"],
        },
      ],
      "lastUpdated",
    );
...
export class EmergencyService {
  static async createRequest(
    requestData: Omit<EmergencyRequest, "requestId" | "timestamp">,
  ): Promise<string> {
    return DatabaseService.create<EmergencyRequest>(
  ...
  static async getRequest(requestId: string): Promise<EmergencyRequest | null> {
    return DatabaseService.get<EmergencyRequest>(
      COLLECTIONS.EMERGENCY_REQUESTS,
      requestId,
    );
  }
  ...
  static async updateRequest(
    ...
    return DatabaseService.update<EmergencyRequest>(
      COLLECTIONS.EMERGENCY_REQUESTS,
      requestId,
      requestData,
    );
...
export class AdminService {
  static async createLog(
    logData: Omit<AdminLog, "logId" | "timestamp">,
  ): Promise<string> {
    return DatabaseService.create<AdminLog>(
  ...
  static async getLogsByCategory(
