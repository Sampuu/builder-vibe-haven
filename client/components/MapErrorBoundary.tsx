        ...
        <Card className="w-full">
          ...
          <CardContent className="space-y-4">
            <Alert variant="destructive">
              ...
              <AlertDescription>
                The interactive map failed to load properly. This could be due to network issues or browser compatibility.
              </AlertDescription>
            </Alert>
            ...
            <div className="bg-slate-100 p-6 rounded-lg border-2 border-dashed border-slate-300 text-center">
              ...
              <p className="text-lg font-medium text-slate-700 mb-2">Map Unavailable</p>
              <p className="text-sm text-slate-600 mb-4">
                The emergency map service is temporarily unavailable. 
                You can still access emergency contacts and report incidents.
              </p>
            ...
            <div className="bg-emergency-danger/10 p-4 rounded-lg border border-emergency-danger/20">
              <h3 className="font-medium text-emergency-danger mb-2">Emergency Contacts</h3>
