  ...
  useEffect(() => {
    ...
    const setupListeners = () => {
      try {
        ...
        const unsubReports = firebaseDb.disasterReports.subscribeToReports((reports) => {
        ...
        const unsubHelp = firebaseDb.helpRequests.subscribeToHelpRequests((requests) => {
        ...
        // Incidents listener
        const unsubIncidents = firebaseDb.incidents.subscribeToIncidents((incidents) => {
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Live monitoring of Firebase Firestore collections and real-time listeners
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <Alert className={`${allConnected ? 'border-green-500 bg-green-50' : 'border-yellow-500 bg-yellow-50'}`}>
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant={connectionStatus.users ? "default" : "secondary"}>
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">{stats.disasterReports}</p>
                  </div>
                  <Badge variant={connectionStatus.disasterReports ? "default" : "secondary"}>
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant={connectionStatus.helpRequests ? "default" : "secondary"}>
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant={connectionStatus.newsUpdates ? "default" : "secondary"}>
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant={connectionStatus.incidents ? "default" : "secondary"}>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 gap-2 text-sm">
              <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
                <span><strong>users</strong> - User authentication profiles and roles</span>
                <Badge variant={connectionStatus.users ? "default" : "secondary"} size="sm">
                  {connectionStatus.users ? "🟢 Connected" : "🟡 Connecting"}
                </Badge>
              </div>
              <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
                <span><strong>disasterReports</strong> - All disaster report submissions</span>
                <Badge variant={connectionStatus.disasterReports ? "default" : "secondary"} size="sm">
                  {connectionStatus.disasterReports ? "🟢 Connected" : "🟡 Connecting"}
                </Badge>
              </div>
              <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
                <span><strong>helpRequests</strong> - All help or SOS requests</span>
                <Badge variant={connectionStatus.helpRequests ? "default" : "secondary"} size="sm">
                  {connectionStatus.helpRequests ? "🟢 Connected" : "🟡 Connecting"}
                </Badge>
              </div>
              <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
                <span><strong>newsUpdates</strong> - All news, alerts, and announcements</span>
                <Badge variant={connectionStatus.newsUpdates ? "default" : "secondary"} size="sm">
                  {connectionStatus.newsUpdates ? "🟢 Connected" : "🟡 Connecting"}
                </Badge>
              </div>
              <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
                <span><strong>incidents</strong> - Active emergency incidents</span>
                <Badge variant={connectionStatus.incidents ? "default" : "secondary"} size="sm">
                  {connectionStatus.incidents ? "🟢 Connected" : "🟡 Connecting"}
                </Badge>
              </div>
            </div>
          </div>
          ...
          <Alert>
            ...
            <AlertDescription>
              <strong>Real-time synchronization active:</strong> All collections are monitored with 
              Firebase onSnapshot listeners. Data updates automatically across all connected clients.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
