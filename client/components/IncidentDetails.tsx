      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <AlertTriangle
              className="h-5 w-5"
              style={{ color: incidentType.color }}
            />
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm">
            {incident.position.lat.toFixed(6)},{" "}
            {incident.position.lon.toFixed(6)}
          </span>
        </div>
        ...
        <div className="p-3 bg-slate-50 rounded-lg">
          ...
          <div className="text-xs text-slate-600">
            ...
            {incident.severity === "high" &&
              "⚠️ High priority - respond within 5 minutes"}
            {incident.severity === "medium" &&
              "⏱️ Medium priority - respond within 15 minutes"}
            {incident.severity === "low" &&
              "📋 Low priority - respond when available"}
        ...
        {incident.severity === "critical" && (
          <div className="p-3 bg-emergency-danger/10 border border-emergency-danger/20 rounded-lg">
            ...
            <div className="text-xs text-emergency-danger/80">
              All available units should respond immediately. Establish command
              post and coordinate with other agencies.
            </div>
