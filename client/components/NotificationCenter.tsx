...
export default function NotificationCenter() {
  ...
  const getNotificationIcon = (type: string) => {
    switch (type) {
      case "error":
        return <XCircle className="h-4 w-4 text-emergency-danger" />;
      case "warning":
        return <AlertTriangle className="h-4 w-4 text-emergency-warning" />;
      case "success":
        return <CheckCircle className="h-4 w-4 text-emergency-resolved" />;
      case "info":
      default:
        return <Info className="h-4 w-4 text-emergency-info" />;
    }
  };
  ...
  const getNotificationBgColor = (type: string) => {
    switch (type) {
      case "error":
        return "bg-emergency-danger/10 border-emergency-danger/20";
      case "warning":
        return "bg-emergency-warning/10 border-emergency-warning/20";
      case "success":
        return "bg-emergency-resolved/10 border-emergency-resolved/20";
      case "info":
      default:
        return "bg-emergency-info/10 border-emergency-info/20";
    }
  };
