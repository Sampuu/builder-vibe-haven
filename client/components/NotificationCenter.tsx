...
export default function NotificationCenter({
  ...
  const loadNotifications = async () => {
    try {
      const allNotifications = await getNotificationsForDepartment(
        department as any,
      );
                ...
                return (
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      <div
                        className={`p-2 rounded-full ${getSeverityColor(notification.severity)}`}
                      >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center space-x-4 text-xs text-slate-500">
                          <div className="flex items-center space-x-1">
                            ...
                            <span>
                              {formatTimeAgo(notification.timestamps.sent)}
                            </span>
                          </div>
              ...
              <DialogHeader>
                <div className="flex items-center justify-between">
                  <DialogTitle className="flex items-center space-x-2">
                    <div
                      className={`p-2 rounded-full ${getSeverityColor(selectedNotification.severity)}`}
                    >
              ...
              <div className="space-y-4">
                ...
                <Alert className="border-orange-200 bg-orange-50">
                  ...
                  <AlertDescription className="font-medium text-orange-800">
                    Emergency response required - please acknowledge receipt and
                ...
                {selectedNotification.acknowledgments.length > 0 && (
                  <div>
                    ...
                    <div className="mt-2 space-y-2">
                      {selectedNotification.acknowledgments.map(
                        (ack, index) => (
                          <div
                            key={index}
                ...
                {/* Response Section */}
                {!selectedNotification.acknowledgments.some(
                  (ack) => ack.userId === user?.id,
                ) && (
                  <div>
                    <label className="text-sm font-medium text-slate-700">
