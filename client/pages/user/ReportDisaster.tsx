...
import {
  saveReport,
  mapLegacyTypeToProbleType,
  createGeneralUserReport,
...
const disasterTypes = [
  {
    ...
    problemType: "fire" as ReportProblemType,
  },
  {
    value: "medical",
    label: "Medical Emergency",
    description: "Injuries, accidents, health emergencies",
    problemType: "ambulance" as ReportProblemType,
  },
  {
    value: "accident",
    label: "Traffic/Transport Accident",
    description: "Vehicle collisions, road incidents",
    problemType: "police" as ReportProblemType,
  },
  {
    value: "natural",
    label: "Natural Disaster",
    description: "Floods, storms, earthquakes",
    problemType: "general" as ReportProblemType,
  },
  {
    value: "hospital",
    label: "Hospital/Medical Facility",
    description: "Hospital equipment, staff shortages, supplies",
    problemType: "hospital" as ReportProblemType,
  },
  {
    value: "other",
