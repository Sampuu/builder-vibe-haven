          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-slate-600">
                Interactive map with real-time incidents and emergency services
              </p>
            </div>
          </div>
            ...
            <Card>
              <CardContent className="p-0">
                <DynamicEmergencyMap
                  ...
                  showEntities={
                    filterType === "all" || filterType === "entities"
                  }
                  showIncidents={
          ...
          <div className="space-y-6">
                      ...
                      {selectedIncident.respondingUnits && (
                        <div>
                          ...
                          <div className="flex flex-wrap gap-1">
                            {selectedIncident.respondingUnits.map(
                              (unit, index) => (
                                <Badge
                                  key={index}
                                  variant="outline"
                    ...
                    <div className="space-y-3">
                      ...
                      {selectedEntity.specialties && (
                        <div>
                          ...
                          <div className="flex flex-wrap gap-1">
                            {selectedEntity.specialties.map(
                              (specialty, index) => (
                                <Badge
                                  key={index}
                                  variant="outline"
                      ...
                      <div className="flex gap-2 pt-2">
                        <Button
                          ...
                          variant="outline"
                          onClick={() =>
                            window.open(`tel:${selectedEntity.phone}`, "_self")
                          }
                          className="flex-1"
                        >
                          <Phone className="h-3 w-3 mr-1" />
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Hospitals, police, fire stations nearby
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3 max-h-64 overflow-y-auto">
