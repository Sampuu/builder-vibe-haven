...
const mockIncidents: IncidentMarker[] = [
  {
    ...
    description:
      "Multi-story commercial building fire with potential structural damage",
    severity: "high",
  ...
  },
  {
    ...
    description:
      "3-car collision blocking two lanes, emergency responders on scene",
    severity: "medium",
                  ...
                  {mockIncidents.map((incident) => (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between text-xs text-slate-500">
                        ...
                        <div>{getTimeAgo(incident.timestamp)}</div>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <CardContent className="space-y-3">
                <div className="text-sm space-y-2">
                  <div className="flex justify-between">
                    ...
                    <Button
                      variant="link"
                      className="p-0 h-auto text-emergency-danger"
                      onClick={() => window.open("tel:911")}
                    >
                      911
                    </Button>
                  ...
                  <div className="flex justify-between">
                    ...
                    <Button
                      variant="link"
                      className="p-0 h-auto text-emergency-info"
