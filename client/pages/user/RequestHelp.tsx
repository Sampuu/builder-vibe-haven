...
export default function RequestHelp() {
  ...
  const validateForm = () => {
    ...
    if (!formData.category)
      newErrors.category = "Please select the type of help needed";
          ...
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="text-slate-600 mb-4">
                Your help request has been submitted and the appropriate
                emergency departments have been notified.
              </p>
      ...
      <div className="space-y-6">
        ...
        <Alert className="border-emergency-danger bg-emergency-danger/5">
          ...
          <AlertDescription className="text-emergency-danger font-medium">
            For life-threatening emergencies, call 911 immediately before
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Submit a request for emergency assistance. Your request will be
                automatically routed to the appropriate departments.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger
                      className={
                        errors.category ? "border-emergency-danger" : ""
                      }
                    >
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="text-emergency-danger font-medium">
                    Critical:
                  </span>
                  <span>Immediate response</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-emergency-warning font-medium">
                    High:
                  </span>
                  <span>Within 15 minutes</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-emergency-info font-medium">
                    Medium:
                  </span>
