...
const mockNewsArticles: NewsArticle[] = [
  {
    id: "1",
    title:
      "Major Fire Outbreak at Downtown Plaza - Immediate Evacuation Required",
...
The situation is being closely monitored. Updates will be provided every 30 minutes until resolved.`,
    summary:
      "Major fire at Downtown Plaza requires immediate evacuation. Fire Brigade and emergency services responding.",
...
Medical teams report all patients are receiving appropriate care. The highway is expected to reopen fully by 4:00 PM.`,
    summary:
      "Multi-vehicle accident on Highway 101. Emergency medical response in progress.",
  ...
  },
  {
    id: "3",
    title:
      "Weather Alert: Severe Storm Warning - Emergency Supplies Deployment",
...
Emergency supply teams will be operating 24/7 during the storm period.`,
    summary:
      "Severe storm warning issued. Emergency supplies being deployed to community centers.",
  ...
  fire: [
    {
      ...
      description:
        "Send additional fire trucks and personnel to Downtown Plaza",
      type: "deployment",
      assignedTo: "fire",
      status: "in-progress",
      priority: "critical",
  ...
  hospital: [
    {
      ...
      description:
        "Deploy emergency food, medical supplies, and shelter materials",
      type: "supply",
      assignedTo: "hospital",
      status: "in-progress",
      priority: "high",
  ...
  police: [
    {
      ...
      description:
        "Coordinate traffic management and assist with building evacuation",
      type: "coordination",
      assignedTo: "police",
      status: "in-progress",
      priority: "high",
...
export default function NewsDetail() {
  ...
  const getPriorityColor = (priority: string) => {
    switch (priority) {
      case "critical":
        return "bg-emergency-danger text-white";
      case "high":
        return "bg-emergency-warning text-white";
      case "medium":
        return "bg-emergency-info text-white";
      case "low":
              ...
              {article.content.split("\n").map((paragraph, index) => {
                if (paragraph.startsWith("**") && paragraph.endsWith("**")) {
                  return (
                    <h3
                      key={index}
                      className="text-lg font-semibold mt-6 mb-3 text-slate-900"
                    >
                      {paragraph.slice(2, -2)}
                    </h3>
                  );
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <Badge
                          className={`${getStatusColor(action.status)} text-white`}
                        >
                          {action.status}
                        </Badge>
                      </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4 mb-4">
                      <div>
                        ...
                        <div className="flex items-center space-x-2 text-sm text-slate-600">
                          ...
                          <span>
                            {action.estimatedTime || action.actualTime || "TBD"}
                          </span>
                        </div>
                      </div>
                          ...
                          <div className="space-y-1">
                            {action.resources.personnel && (
                              <div className="flex items-center space-x-2">
                                ...
                                <span>
                                  {action.resources.personnel} personnel
                                </span>
                              </div>
                            )}
                            {action.resources.vehicles && (
                              <div className="flex items-center space-x-2">
                                ...
                                <span>
                                  {action.resources.vehicles.join(", ")}
                                </span>
                              </div>
                            )}
                            {action.resources.supplies && (
                              <div className="flex items-center space-x-2">
                                ...
                                <span>
                                  {action.resources.supplies.join(", ")}
                                </span>
                              </div>
                            )}
                          </div>
