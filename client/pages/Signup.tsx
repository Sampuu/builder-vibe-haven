            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger
                    className={
                      validationErrors.role ? "border-emergency-danger" : ""
                    }
                  >
              ...
              {isEmergencyRole && (
                <Alert className="border-emergency-warning bg-emergency-warning/5">
                  ...
                  <AlertDescription className="text-emergency-warning">
                    <strong>Emergency Role Selected:</strong> Your account will
                    require verification before full access is granted. Please
                    ensure you have proper credentials for this role.
                  </AlertDescription>
                </Alert>
              )}
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={
                      validationErrors.name ? "border-emergency-danger" : ""
                    }
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={
                      validationErrors.phone ? "border-emergency-danger" : ""
                    }
                  />
              ...
              <div className="space-y-2">
                <div className="flex items-start space-x-2">
                  <Checkbox
                    ...
                    className={
                      validationErrors.terms ? "border-emergency-danger" : ""
                    }
                  />
                  <Label
                    htmlFor="terms"
                  ...
                  >
                    ...
                    . I understand that emergency role accounts require
                    verification.
                  </Label>
                </div>
