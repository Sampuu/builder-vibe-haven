...
export default function AdminDashboard() {
  ...
  const getDashboardStats = () => {
    return {
      police: incidents.filter(i => i.type === 'accident' || i.type === 'police').length,
  ...
  useEffect(() => {
    if (dataInitialized) {
      console.log('Admin dashboard data loaded:', incidents.length, 'incidents,', missions.length, 'missions');
    }
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <Button
                ...
                className="mt-2"
              >
                <RefreshCw className={`mr-2 h-4 w-4 ${(incidentsLoading || missionsLoading) ? 'animate-spin' : ''}`} />
                Refresh All
              </Button>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader className="text-center">
              ...
              <CardDescription>Add, remove, edit users ({totalUsers} total)</CardDescription>
            </CardHeader>
            <CardContent>
              <Button className="w-full" variant="default" onClick={() => navigate('/admin/users')}>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader className="text-center">
              ...
              <CardDescription>Mark complete, refresh, delete ({missions.length} active)</CardDescription>
            </CardHeader>
            <CardContent>
              <Button className="w-full" variant="info" onClick={() => navigate('/admin/missions')}>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <Button className="w-full" variant="warning" onClick={() => navigate('/admin/logs')}>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <Button className="w-full" variant="danger" onClick={() => navigate('/admin/dashboards')}>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                Quick Stats
                <Badge variant="outline">{incidentsLoading || missionsLoading ? 'Loading...' : 'Live'}</Badge>
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-emergency-danger">{activeIncidents}</span>
                </div>
                <div className="flex justify-between">
                  <span>Resolved Today</span>
                  <span className="font-semibold text-emergency-resolved">{resolvedToday}</span>
                </div>
                <div className="flex justify-between">
                  <span>System Status</span>
                  <span className="font-semibold text-emergency-resolved">{systemStatus}</span>
                </div>
                <div className="flex justify-between">
                  <span>Total Missions</span>
                  <span className="font-semibold text-emergency-info">{missions.length}</span>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center space-x-2">
                    <Badge variant="outline">{dashboardStats.police} incidents</Badge>
                    <Button size="sm" variant="outline" onClick={() => navigate('/dashboard/police')}>
                      View
                    </Button>
                  </div>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center space-x-2">
                    <Badge variant="outline">{dashboardStats.fire} incidents</Badge>
                    <Button size="sm" variant="outline" onClick={() => navigate('/dashboard/fire')}>
                      View
                    </Button>
                  </div>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center space-x-2">
                    <Badge variant="outline">{dashboardStats.ambulance} incidents</Badge>
                    <Button size="sm" variant="outline" onClick={() => navigate('/dashboard/ambulance')}>
                      View
                    </Button>
                  </div>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center space-x-2">
                    <Badge variant="outline">{dashboardStats.hospital} requests</Badge>
                    <Button size="sm" variant="outline" onClick={() => navigate('/dashboard/hospital')}>
                      View
                    </Button>
                  </div>
                </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 border rounded">
                  <div>
                    ...
                    <div className="text-sm text-slate-600">Full system administration privileges</div>
                  </div>
                  <Dialog>
                    ...
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          This will grant full system administration privileges. Are you sure?
                        </DialogDescription>
                      </DialogHeader>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 border rounded">
                  <div>
                    ...
                    <div className="text-sm text-slate-600">Administrative panel privileges</div>
                  </div>
                  <Dialog>
                    <DialogTrigger asChild>
                      <Button
                    ...
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          This will activate administrative panel privileges. Continue?
                        </DialogDescription>
                      </DialogHeader>
                      <div className="flex space-x-2">
