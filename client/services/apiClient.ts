...
export const incidentAPI = {
  ...
  async getForDepartment(department: UserRole): Promise<GetIncidentsResponse> {
    return apiRequest<GetIncidentsResponse>(
  ...
  async getById(
    ...
    return apiRequest<{ success: boolean; incident: Incident }>(
  ...
  async updateStatus(
    ...
    return apiRequest<UpdateIncidentStatusResponse>(
  ...
  async acknowledge(
    incidentId: string,
    department: UserRole,
    acknowledgedBy: { userId: string; role: UserRole },
  ): Promise<AcknowledgeIncidentResponse> {
    ...
    return apiRequest<AcknowledgeIncidentResponse>(
  ...
  async getRecent(
    limit: number = 10,
  ): Promise<{ success: boolean; incidents: Incident[] }> {
    return apiRequest<{ success: boolean; incidents: Incident[] }>(
      `/incidents/recent?limit=${limit}`,
    );
  },
};
...
export const notificationAPI = {
  ...
  async broadcastNews(
    newsData: BroadcastNewsRequest,
  ): Promise<BroadcastNewsResponse> {
